...
filtered_data <- filtered_data %>% st_transform(4326)
vegr <- st_transform(vegr, 4326)

library(RColorBrewer)
species_palette <- colorFactor(brewer.pal(min(9, length(unique(filtered_data$Species))), "Set1"), filtered_data$Species)
